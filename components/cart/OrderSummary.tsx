...
export const OrderSummary: FC<Props> = ({ orderValues }) => {
  ...
  return (
    <Grid container>
      <Grid item xs={6}>
        <Typography sx={{ color: "darkcyan" }}>No. Productos</Typography>
      </Grid>
      <Grid item xs={6} display="flex" justifyContent="end">
        <Typography sx={{ color: "darkcyan" }}>
      ...
      <Grid item xs={6}>
        <Typography sx={{ color: "darkcyan" }}>SubTotal</Typography>
      </Grid>
      <Grid item xs={6} display="flex" justifyContent="end">
        <Typography sx={{ color: "darkcyan" }}>
      ...
      <Grid item xs={6} sx={{ mt: 2 }}>
        <Typography variant="subtitle1" sx={{ color: "darkcyan" }}>
          Total:
        </Typography>
      </Grid>
